...
_See code: [src/commands/project/add.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/project/add.ts)_
...
_See code: [src/commands/project/list.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/project/list.ts)_
...
_See code: [src/commands/project/remove.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/project/remove.ts)_
...
_See code: [src/commands/project/set-default.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/project/set-default.ts)_
...
_See code: [src/commands/service/origin/list.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/service/origin/list.ts)_
...
_See code: [src/commands/service/origin/set.ts](https://github.com/kgalli/cliw/blob/v0.5.0/src/commands/service/origin/set.ts)_
